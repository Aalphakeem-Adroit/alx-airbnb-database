...
--  Author: Busari Abdulhakeem Tunde (Aalphakeem Adroit)
--  Objective: Create normalized tables with constraints & indexes
-- ===========================================================

-- Enable UUID extension for PostgreSQL (optional if not already enabled)
...
-- Index for fast filtering by location and host
...
-- Index for fast booking-based queries
...
-- Indexes for fast property & user review lookups
